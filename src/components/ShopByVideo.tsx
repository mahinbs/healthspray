        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm px-4">
          <div className="relative w-full max-w-sm bg-black rounded-3xl overflow-hidden shadow-2xl max-h-[90vh]">
            ...
            <div className="relative aspect-[9/13] bg-black">
              ...
              <div className="absolute top-16 right-4 flex flex-col items-center space-y-4 text-white bg-black/40 p-2 rounded-xl">
                ...
                <div className="flex flex-col items-center">
                  ...
                  >
                    <Heart
                      className={`h-5 w-5 ${
                        isInWishlist(selectedProduct.id) ? "fill-[#ef4e23]" : ""
                      }`}
                    />
                  </button>
