...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-orange-900 via-orange-800 to-orange-900 text-white overflow-hidden">
      {/* Background Effects */}
      <div className="absolute inset-0 bg-gradient-mesh opacity-30" />
      <div className="absolute inset-0 bg-orange-100/10 backdrop-blur-3xl" />
      
      {/* Animated Background Elements */}
      <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full opacity-20 blur-3xl animate-float" />
      <div className="absolute bottom-0 right-0 w-80 h-80 bg-gradient-to-br from-orange-300 to-orange-500 rounded-full opacity-15 blur-3xl animate-float" style={{ animationDelay: "2s" }} />
      ...
      <div className="relative z-10">
              ...
              <div className="space-y-4">
                ...
                <div className="flex space-x-4">
                          <button
                            ...
                            className="p-3 bg-white/10 hover:bg-orange-600 rounded-full transition-all duration-300 hover:scale-110 backdrop-blur-md border border-orange-200/20"
                            title="Facebook"
                          >
                  ...
                  <button
                    ...
                    className="p-3 bg-white/10 hover:bg-orange-500 rounded-full transition-all duration-300 hover:scale-110 backdrop-blur-md border border-orange-200/20"
                    title="Twitter"
                  >
                  ...
                  <button
                    ...
                    className="p-3 bg-white/10 hover:bg-orange-400 rounded-full transition-all duration-300 hover:scale-110 backdrop-blur-md border border-orange-200/20"
                    title="Instagram"
                  >
                ...
                <form onSubmit={handleSubscribe} className="space-y-3">
                  <input
                    ...
                    onChange={(e) => setEmail(e.target.value)}
                            className="w-full px-4 py-3 bg-white/10 border border-orange-200/20 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent backdrop-blur-md"
                    required
                  />
                  <Button
                    type="submit"
        ...
        {/* Bottom Bar */}
        <div className="border-t border-orange-200/20 bg-orange-900/20 backdrop-blur-md">
